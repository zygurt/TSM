function [ Ref, Test ] = fft_pre_pro( Ref_Model, Test_Model, General )
...
if debug_var
disp('Pre-processing Excitation Patterns')
end
StepSize = General.BasicStepSize;

fc = Ref_Model.bands(2,:);
%Z is defined above
...
[Ref.E_P, Test.E_P] = pattern_adapt( Ref.E_L, Test.E_L, fc, StepSize, General.fs, 'basic', General.model);
