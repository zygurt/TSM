function [processing_time] = Generate_Features(match_method)
...
for k = 1:K
    ...
    c_date = clock;
    sname = sprintf('MOVs_Eval_%s%s%s%s.mat',num2str(c_date(1)),num2str(c_date(2),'%02d'),num2str(c_date(3),'%02d'),match_method);
