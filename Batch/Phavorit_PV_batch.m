function [ y_out ] = Phavorit_PV_batch( x, N, TSM, PL, filename )
...
for t = 1:length(TSM)
    ...
    switch PL
        ...
        case 1
            f = [filename(1:end-4) sprintf('_Phavorit_SPL_%g',tsm*100) '.wav'];
        otherwise
            f = [filename(1:end-4) sprintf('_Phavorit_UNKNOWN_PL_%g',tsm*100) '.wav'];
    end
    audiowrite(f,y,fs);
end
end
